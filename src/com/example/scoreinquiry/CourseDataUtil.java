...
class CourseScoreDataBaseHelper extends SQLiteOpenHelper
{
	final String CREATE_TABLE_SQL =
		...
		+ "type TEXT,credit TEXT,teacher TEXT,academy TEXT,major TEXT,year TEXT,term TEXT,score TEXT)";
...
public class CourseDataUtil{
	...
	public List<Map<String, String>> getAllCourseScoreData(){
		...
		for(cursor.moveToFirst();!cursor.isAfterLast();cursor.moveToNext())
		{
			...
			course.put("year", cursor.getString(cursor.getColumnIndex("year")));
			course.put("term", cursor.getString(cursor.getColumnIndex("term")));
	...
	public void addCourseScoreData(List<Map<String, String>> courseInfo){
		...
		try{
			for(Map<String, String> course:courseInfo){
				...
				strings[7]=course.get("year");
				strings[8]=course.get("term");
				strings[9]=course.get("score");
